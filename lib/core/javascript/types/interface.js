...
export type PayloadType = any; // eslint-disable-line flowtype/no-weak-types
export type RxStreamType = any; // eslint-disable-line flowtype/no-weak-types
export type StateType = any; // eslint-disable-line flowtype/no-weak-types
...
export type ActionContextType = (id: ?string) => ActionType;
...
export type OptionsType = {
    ...
    storage: {
        ...
        driverOpts: Object, // eslint-disable-line flowtype/no-weak-types
        host: ?string,
        port: number,
        db: string,
        table: string
