...
import {
    DEFAULT_KAKKA_APPLICATION_NAME,
    DEFAULT_KAKKA_SERVICE_NAME,
    DEFAULT_KAKKA_DISCOVERY_BEACON_PORT,
    DEFAULT_KAKKA_DISCOVERY_IP_VERSION,
    DEFAULT_KAKKA_DISCOVERY_PIPE_PORT,
    DEFAULT_KAKKA_DISCOVERY_PIPE_PREFIX,
    DEFAULT_KAKKA_ACTION_GATE_HOST,
    DEFAULT_KAKKA_ACTION_GATE_PORT
} from './const'
...
const DEFAULT_OPTS: OptionsType = {
    app: DEFAULT_KAKKA_APPLICATION_NAME,
    service: DEFAULT_KAKKA_SERVICE_NAME,
    debug: false,
    ...
    pipe: {
        port: DEFAULT_KAKKA_DISCOVERY_PIPE_PORT,
        connectTo: null,
        prefix: DEFAULT_KAKKA_DISCOVERY_PIPE_PREFIX,
        discoveryBeacon: {
            port: DEFAULT_KAKKA_DISCOVERY_BEACON_PORT,
            ipVersion: DEFAULT_KAKKA_DISCOVERY_IP_VERSION
        },
        discovery: {
            port: DEFAULT_KAKKA_DISCOVERY_BEACON_PORT,
            ipVersion: DEFAULT_KAKKA_DISCOVERY_IP_VERSION
    ...
    actionGate: {
        host: DEFAULT_KAKKA_ACTION_GATE_HOST,
        port: DEFAULT_KAKKA_ACTION_GATE_PORT,
        prefix: null,
        putActions: [],
        putSessionActions: [],
        socketServer: {
...
export function buildGlobalObjectName(opts: OptionsType): string {
    const app = (opts && isString(opts.app)) ? opts.app : DEFAULT_KAKKA_APPLICATION_NAME;
    const service = (opts && isString(opts.service)) ? opts.service : DEFAULT_KAKKA_SERVICE_NAME;
