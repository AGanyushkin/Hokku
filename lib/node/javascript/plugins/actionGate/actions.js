// @flow
import type {
    ActionType, HokkuType, PayloadType
...
export function ActionGatePutToSessionState(payload: PayloadType) {
    return {
...
export function ActionGateSessionState(payload: PayloadType) {
    return {
...
export function ActionGatePutToState(payload: PayloadType) {
    return {
...
export function ActionGateState(payload: PayloadType) {
    return {
