...
function do_ACTION_SELF_INFO(hokku: HokkuType, conn: ConnectionType, action: PipeProtocolActionType): void {
...
function do_ACTION_TRANSPORTER(hokku: HokkuType, conn: ConnectionType, action: PipeProtocolActionType): void {
    if (conn.state !== 'LIVE') {
...
function do_ACTION_LIVE(hokku: HokkuType, conn: ConnectionType, action: PipeProtocolActionType): void {
    // console.log(`do_ACTION_LIVE ${hokku.opts.service} <-> ${conn.serviceid}`);
...
function do_ACTION_CLUSTER_INFO(hokku: HokkuType, conn: ConnectionType, action: PipeProtocolActionType): void {
...
function do_ACTION_GET_CLUSTER_INFO(hokku: HokkuType, conn: ConnectionType, action: PipeProtocolActionType): void {
    if (conn.state !== 'LIVE') {
...
function handlePipeActionFactory(hokku: HokkuType, conn: ConnectionType) {
    return function handlePipeAction(action: PipeProtocolActionType) {
        switch (action.type) {
            case ACTION_SELF_INFO: do_ACTION_SELF_INFO(hokku, conn, action); break;
            case ACTION_TRANSPORTER: do_ACTION_TRANSPORTER(hokku, conn, action); break;
            case ACTION_LIVE: do_ACTION_LIVE(hokku, conn, action); break;
            case ACTION_CLUSTER_INFO: do_ACTION_CLUSTER_INFO(hokku, conn, action); break;
            case ACTION_GET_CLUSTER_INFO: do_ACTION_GET_CLUSTER_INFO(hokku, conn, action); break;
            default:
