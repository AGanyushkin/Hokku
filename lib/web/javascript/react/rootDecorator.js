...
import {withRouter, BrowserRouter} from 'react-router-dom'; // eslint-disable-line no-unused-vars
...
function decoratorHokkuUIReactRootFactory(Hokku: HokkuType): ReactRootDecoratorType {
    return function decoratorHokkuUIReactRoot(CLS: ReactComponentType): void {
        ...
        const InnerCLS: ReactClassType = withRouter(InternalReactRouterGlue); // eslint-disable-line no-unused-vars
